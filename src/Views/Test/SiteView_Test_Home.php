...
class SiteView_Test_Home extends SiteView
{
    ...
    {
        $class_Name = 'Src\LangFiles\Views\Test\Home\LangFiles_'.$this->ucfirstLang($this->userLang).'_'.'Views_T_H_Head';
        return new $class_Name();
    }

    protected function replaceDefaultHeaderLang()
    {
        $class_Name = 'Src\LangFiles\Views\Test\Home\LangFiles_'.$this->ucfirstLang($this->userLang).'_'.'Views_T_H_Header';
        return new $class_Name();
    }
}