...
class SiteView_JointSite_Arch extends SiteView_JointSite
{
    ...
    {
        $class_Name = 'JointApp\LangFiles\Views\JointSite\Design\LangFiles_'.$this->ucfirstLang($this->userLang).'_'.'Views_JS_A_Head';
        return new $class_Name();
    }

    protected function replaceDefaultHeaderLang()
    {
        $class_Name = 'JointApp\LangFiles\Views\JointSite\Design\LangFiles_'.$this->ucfirstLang($this->userLang).'_'.'Views_JS_A_Header';
        return new $class_Name();
    }
    ...
    protected function handleTpSiteView(): string
    {
        return '<div class="contentBlock-frame"><div class="contentBlock-center">'.
            '<div class="contentBlock-wrap">22222'.$this->tpSet->SiteView->getResponseHtml().
            '</div></div></div>';
    }
}