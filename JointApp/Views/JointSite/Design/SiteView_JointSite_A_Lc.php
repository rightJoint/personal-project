...
class SiteView_JointSite_A_Lc extends SiteView_JointSite
{
    ...
    {
        $class_Name = 'JointApp\LangFiles\Views\JointSite\Design\LangFiles_'.$this->ucfirstLang($this->userLang).'_'.'Views_JS_A_Lc_Head';
        return new $class_Name();
    }

    protected function replaceDefaultHeaderLang()
    {
        $class_Name = 'JointApp\LangFiles\Views\JointSite\Design\LangFiles_'.$this->ucfirstLang($this->userLang).'_'.'Views_JS_A_Lc_Header';
        return new $class_Name();
    }
