...
class TpView_JointSite_Deploy_Hosting extends TpView
{
    protected $css = [
    ...
    {
        $class_Name = 'JointApp\LangFiles\Views\JointSite\Deploy\LangFiles_'.self::ucfirstLang($this->userLang).'_'.'Views_JS_D_H_Article';
