...
namespace JointApp\Views\JointSite\User;
...
class SiteView_JointSite_User_About extends SiteView_JointSite
{
    ...
    {
        $class_Name = 'JointApp\LangFiles\Views\JointSite\User\LangFiles_'.$this->ucfirstLang($this->userLang).'_'.'Views_JS_U_A_Head';
        return new $class_Name();
    }

    protected function replaceDefaultHeaderLang()
    {
        $class_Name = 'JointApp\LangFiles\Views\JointSite\User\LangFiles_'.$this->ucfirstLang($this->userLang).'_'.'Views_JS_U_A_Header';
        return new $class_Name();
    }
