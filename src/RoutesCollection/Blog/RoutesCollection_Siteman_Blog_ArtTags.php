...
trait RoutesCollection_Siteman_Blog_ArtTags
{
    static function getRoute_SitemanBlogArtTags($routes_ns):JointSiteRoute
    {
        $route = new JointSiteRoute();
        $route
            ->withController('Src\Controllers\Blog\Controller_Siteman_Blog_ArtTags')
            ->withModel('Src\Models\Blog\Model_Siteman_BlogArtTags');
    ...
    static function postRoute_SitemanBlogArtTags($routes_ns):JointSiteRoute
    {
        $route = (new JointSiteRoute())
            ->withController('Src\Controllers\Blog\Controller_Siteman_Blog_ArtTags')
            ->withModel('Src\Models\Blog\Model_Siteman_BlogArtTags');
