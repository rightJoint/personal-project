...
trait RoutesCollection_Siteman_Blog_Tags
{
    static function getRoute_SitemanBlogTags($routes_ns):JointSiteRoute
    {
        $route = new JointSiteRoute();
        $route
            ->withController('Src\Controllers\Blog\Controller_Siteman_Blog_Tags')
            ->withModel('Src\Models\Blog\Model_Siteman_Blog_Tags');
    ...
    static function postRoute_SitemanBlogTags($routes_ns):JointSiteRoute
    {
        $route = (new JointSiteRoute())
            ->withController('Src\Controllers\Blog\Controller_Siteman_Blog_Tags')
            ->withModel('Src\Models\Blog\Model_Siteman_Blog_Tags');
