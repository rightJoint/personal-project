...
class SiteView_JointSite_A_Mvc extends SiteView_JointSite
{
    ...
    {
        $class_Name = 'Src\LangFiles\Views\JointSite\Design\LangFiles_'.$this->ucfirstLang($this->userLang).'_'.'Views_JS_A_Mvc_Head';
        return new $class_Name();
    }

    protected function replaceDefaultHeaderLang()
    {
        $class_Name = 'Src\LangFiles\Views\JointSite\Design\LangFiles_'.$this->ucfirstLang($this->userLang).'_'.'Views_JS_A_Mvc_Header';
        return new $class_Name();
    }
    ...
    protected function handleTpMvc(): string
    {
        ...
        return '<div class="contentBlock-frame"><div class="contentBlock-center">'.
            '<div class="contentBlock-wrap">444'.$this->tpSet->Mvc->renderView().
            '</div></div></div>';
    }
}