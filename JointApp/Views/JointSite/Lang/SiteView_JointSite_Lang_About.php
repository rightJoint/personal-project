...
namespace JointApp\Views\JointSite\Lang;
...
class SiteView_JointSite_Lang_About extends SiteView_JointSite
{
    ...
    {
        $class_Name = 'JointApp\LangFiles\Views\JointSite\Lang\LangFiles_'.$this->ucfirstLang($this->userLang).'_'.'Views_JS_L_A_Head';
        return new $class_Name();
    }

    protected function replaceDefaultHeaderLang()
    {
        $class_Name = 'JointApp\LangFiles\Views\JointSite\Lang\LangFiles_'.$this->ucfirstLang($this->userLang).'_'.'Views_JS_L_A_Header';
        return new $class_Name();
    }
