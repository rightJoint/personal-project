...
class SiteView_Test_Records_TblSelector extends SiteView_Test_Home
{
    ...
    {
        $class_Name = 'Src\LangFiles\Views\Test\Records\LangFiles_'.$this->ucfirstLang($this->userLang).'_'.'Views_T_R_TS_Head';
        return new $class_Name();
    }

    protected function replaceDefaultHeaderLang()
    {
        $class_Name = 'Src\LangFiles\Views\Test\records\LangFiles_'.$this->ucfirstLang($this->userLang).'_'.'Views_T_R_TS_Header';
        return new $class_Name();
    }
}