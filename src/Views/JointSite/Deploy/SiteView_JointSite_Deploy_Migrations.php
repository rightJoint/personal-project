...
class SiteView_JointSite_Deploy_Migrations extends SiteView_JointSite
{
    ...
    {
        $class_Name = 'Src\LangFiles\Views\JointSite\Deploy\LangFiles_'.$this->ucfirstLang($this->userLang).'_'.'Views_JS_D_M_Head';
        return new $class_Name();
    }

    protected function replaceDefaultHeaderLang()
    {
        $class_Name = 'Src\LangFiles\Views\JointSite\Deploy\LangFiles_'.$this->ucfirstLang($this->userLang).'_'.'Views_JS_D_M_Header';
        return new $class_Name();
    }
