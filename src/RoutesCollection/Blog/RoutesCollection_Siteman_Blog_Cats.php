...
trait RoutesCollection_Siteman_Blog_Cats
{
    static function getRoute_SitemanBlogCats($routes_ns):JointSiteRoute
    {
        $route = new JointSiteRoute();
        $route
            ->withController('Src\Controllers\Blog\Controller_Siteman_Blog_Cats')
            ->withModel('Src\Models\Blog\Model_Siteman_Blog_Cats');
    ...
    static function postRoute_SitemanBlogCats($routes_ns):JointSiteRoute
    {
        $route = (new JointSiteRoute())
            ->withController('Src\Controllers\Blog\Controller_Siteman_Blog_Cats')
            ->withModel('Src\Models\Blog\Model_Siteman_Blog_Cats');
