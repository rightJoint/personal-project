...
namespace Src\Views\Test\Tables;
...
class SiteView_Test_Tables extends SiteView
{
    ...
    {
        $class_Name = 'Src\LangFiles\Views\Test\Tables\LangFiles_'.$this->ucfirstLang($this->userLang).'_'.'Views_T_T_Head';
        return new $class_Name();
    }

    protected function replaceDefaultHeaderLang()
    {
        $class_Name = 'Src\LangFiles\Views\Test\Tables\LangFiles_'.$this->ucfirstLang($this->userLang).'_'.'Views_T_T_Header';
        return new $class_Name();
    }
