...
namespace JointApp\Views\JointSite\Tests;
...
class SiteView_JointSite_Tests_About extends SiteView_JointSite
{
    ...
    {
        $class_Name = 'JointApp\LangFiles\Views\JointSite\Tests\LangFiles_'.$this->ucfirstLang($this->userLang).'_'.'Views_JS_T_A_Head';
        return new $class_Name();
    }

    protected function replaceDefaultHeaderLang()
    {
        $class_Name = 'JointApp\LangFiles\Views\JointSite\Tests\LangFiles_'.$this->ucfirstLang($this->userLang).'_'.'Views_JS_T_A_Header';
        return new $class_Name();
    }
